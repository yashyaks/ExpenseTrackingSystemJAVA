...
//        setExtendedState(getExtendedState() | JFrame.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Dashboard  >  Income Category");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if(name.getText().trim().isEmpty() ){
            ...
            String query="insert into income_categories(name, description) values ('"+name.getText()+"','"+description.getText()+"') ";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if(name.getText().trim().isEmpty()){
            ...
            String query="update income_categories set name='"+name.getText()+"', description='"+description.getText()+"' where id= '"+id.getText()+"' ";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        // TODO add your handling code here:
        String query="delete from income_categories where id= '"+id.getText()+"' "  ;
